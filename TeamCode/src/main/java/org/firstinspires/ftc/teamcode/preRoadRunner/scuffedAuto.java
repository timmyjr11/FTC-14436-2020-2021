...
public class scuffedAuto extends LinearOpMode {
    ...
    int rect1x = 210; //May need to be adjusted //80
    int rect1y = 107; // May need to be adjusted
    ...
    public void runOpMode() {
        ...
        //Detector
        phoneCam.setPipeline(new scuffedAuto.RingDetectingPipeline());
        ...
        waitForStart();
            ...
            if (opModeIsActive() && countdown.milliseconds() > 150) {
                ...
                backShooter.setVelocity(1989);
                frontShooter.setVelocity(1989);
                stopper.setPosition(0);
                telemetry.clearAll();
                runtime.reset();

                while (opModeIsActive() && runtime.milliseconds() < 4000){
                    telemetry.addLine("Preparing to shoot da rings");
                    telemetry.update();
                }
                ...
                for (int tapMove = 0; tapMove < 6; tapMove++) {
                    ...
                    } else if (tapper.getPosition() == 0.6) {
                        tapper.setPosition(0);
                        frontLeft.setPower(0);
                        frontRight.setPower(0);
                        backLeft.setPower(0);
                    ...
                    tapperTime.reset();
                            ...
                            while (opModeIsActive() && (runtime.milliseconds() < 1300)) {
                                telemetry.addLine("Shooting da rings");
                                telemetry.update();
                            }
                            ...
                            if (ringCount == 1) {//one ring
                                ...
                                while (opModeIsActive() && (runtime.milliseconds() < 1700)) {
                                    telemetry.addLine("1 ring, going right");
                                    telemetry.update();
                                }
                                ...
                                while (opModeIsActive() && (runtime.milliseconds() < 500)){
                                    telemetry.addLine("Going left to line up");
                                    telemetry.update();
                                }
                                ...
                                while (opModeIsActive() && (runtime.milliseconds() < 425)) {
                                ...
                                while (opModeIsActive() && (runtime.milliseconds() < 250)){
                                    telemetry.addLine("rotating for dropping");
                                    telemetry.update();
                                }
                                ...
                                while (opModeIsActive() && (runtime.milliseconds() < 1000)) {
                                    telemetry.addLine("Going up to for teleop");
                                    telemetry.update();
                                }
                                ...
                                while (opModeIsActive() && (runtime.milliseconds() < 1000)) {
                                    telemetry.addLine("Slowing downnnnn");
                                    telemetry.update();
                                }
                                ...
                                while (opModeIsActive() && (runtime.milliseconds() < 2250)) {
                                    telemetry.addLine("Going brrrrrr");
                                    telemetry.update();
                                }
                                ...
                                while (opModeIsActive() && (runtime.milliseconds() < 1000)) {
                                    telemetry.addLine("Going backward to park");
                                    telemetry.update();
                                }
    ...
    class RingDetectingPipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            Rect rect1 = new Rect(rect1x, rect1y, 28,40); //May need to be adjusted
