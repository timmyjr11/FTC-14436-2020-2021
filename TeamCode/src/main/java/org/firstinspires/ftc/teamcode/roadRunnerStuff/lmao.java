...
@Autonomous
@Config
public class lmao extends LinearOpMode {
    ...
    public static double secWobbleGrab = -62;
    ...
    public void runOpMode() {
        ...
        //Detector
        phoneCam.setPipeline(new lmao.RingDetectingPipeline());
        ...
        Trajectory movetoWobbleFour = drive.trajectoryBuilder(grabRing3.end())
                .lineToLinearHeading(new Pose2d(-35.5, -63, Math.toRadians(180)),
                        new MinVelocityConstraint(
                                Arrays.asList(
                                        new AngularVelocityConstraint(221.6),
                                        new MecanumVelocityConstraint(20.6125, DriveConstants.TRACK_WIDTH)
        ...
        Trajectory placeWobbleGoal2One = drive.trajectoryBuilder(grabWobbleGoal1ring.end())
                .lineToLinearHeading(new Pose2d(5, -15, Math.toRadians(0) + 1e-6))
        ...
        Trajectory MovetoShootFourRings = drive.trajectoryBuilder(grabWobbleGoal4ring.end())
                .lineToLinearHeading(new Pose2d(-16, -35, Math.toRadians(0) + 1e-6))
