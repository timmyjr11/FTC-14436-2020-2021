...
@Config
@Disabled
public class ScuffedAutoTest1 extends LinearOpMode {
   ...
   public static double three = 7.5;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.y) {
                ...
                Trajectory startingpos = drive.trajectoryBuilder(shootPowerThree.end())
                        .lineToConstantHeading(new Vector2d(-71, -35))
                        .build();
