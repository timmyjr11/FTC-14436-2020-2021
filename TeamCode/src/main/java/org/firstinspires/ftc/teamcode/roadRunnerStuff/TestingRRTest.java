...
public class TestingRRTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory ShootIntoGoal = drive.trajectoryBuilder(grabRing3.end())
                .splineToLinearHeading(new Pose2d(-17, -30, Math.toRadians(0)), Math.toRadians(0))
        ...
        Trajectory GrabWobbleGoal = drive.trajectoryBuilder(grabRing3.end())
                .lineToLinearHeading(new Pose2d(-40,-56, Math.toRadians(180)),
                        new MinVelocityConstraint(
                        Arrays.asList(
                                new AngularVelocityConstraint(55.4),
                ...
                .addTemporalMarker(0.3, () ->  {
                    ...
                    drive.Gripper.setPosition(1);
                })

                .build();

        Trajectory GrabWobbleGoalRing1 = drive.trajectoryBuilder(grabRing1.end())
                .lineToLinearHeading(new Pose2d(-45,-57, Math.toRadians(180)),
                        new MinVelocityConstraint(
                                Arrays.asList(
        ...
        if (ringCount == 4) {
            ...
            drive.followTrajectory(movingToRing);
            drive.followTrajectory(grabRing1);
            drive.followTrajectory(GrabWobbleGoalRing1);
        } else {
            drive.followTrajectory(GrabWobbleGoal);
        }
