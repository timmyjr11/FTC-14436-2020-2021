...
@TeleOp
@Disabled
public class HbotSolo extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if (gamepad1.left_stick_button && motorSpeed == 0) {
                motorSpeed = 1;
                sleep(250);
            }
            ...
            if (gamepad1.right_trigger > 0.5 && shooterPower == 1) {
                stopperTime.reset();
                while (stopperTime.milliseconds() < 1200) {
            ...
            if (gamepad1.left_trigger > 0.5 && shooterPower == 1) {
                stopperTime.reset();
                while (stopperTime.milliseconds() < 300) {
                    stopper.setPosition(0);
                    frontLeft.setPower(0);
                    frontRight.setPower(0);
                    backLeft.setPower(0);
